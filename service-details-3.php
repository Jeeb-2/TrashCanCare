<?php include "service_header.php"; ?>
                        ...
                        <div class="service-sidebar default-sidebar mr_40">
                            <div class="category-widget sidebar-widget">
                                <ul class="category-list clearfix">
                                    <li><a href="service-details.php"><span>Trash Can Cleaning</span></a></li>
                                    <li><a href="service-details-2.php"><span>Trash Can Emptying</span></a></li>
                                    <li><a href="service-details-3.php" class="current"><span>Trash Can Management</span></a></li>
                                    <li><a href="service-details-4.php"><span>Custumize a service</span></a></li>
                                </ul>
                            </div>
                            <div class="question-widget sidebar-widget">
                                ...
                                <div class="form-inner">
                                    <form method="POST" id="contact_form">
                                        ...
                                        <div class="form-group">
                                            <input type="email" name="email" placeholder="Es-mail address" required>
                                        </div>
                                        <div class="form-group">
