...
<head>
    ...
    <!-- Google Fonts -->
    <link
        href="../../fonts.googleapis.com/css2ab1b.css?family=Fraunces:ital,opsz,wght@0,9..144,300;0,9..144,400;0,9..144,500;0,9..144,600;0,9..144,700;0,9..144,800;0,9..144,900;1,9..144,300;1,9..144,400;1,9..144,500;1,9..144,600;1,9..144,700;1,9..144,800;1,9..144,900&amp;display=swap"
        rel="stylesheet">
    <link
        href="../../fonts.googleapis.com/css25a9b.css?family=Poppins:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&amp;display=swap"
        rel="stylesheet">
...
<link href="assets/css/module-css/sidebar.css" rel="stylesheet">
    ...
    <link rel="stylesheet" type="text/css" href="bootstrap-sweetalert/sweet-alert.css">
...
<body>
    ...
    <div class="boxed_wrapper ltr">
                ...
                <div class="top-inner">
                    <div class="top-left">
                        <ul class="info-list clearfix">
                            ...
                            <li><i class="icon-2"></i>Email: <a
                                    href="mailto:contact@trashcancare.com">contact@trashcancare.com</a></li>
                            <li><i class="icon-3"></i>Address: <span>Madison, Wisconsin. USA</span></li>
                        </ul>
                    </div>
                    <div class="top-right">
                ...
                <div class="outer-box">
                    ...
                    <div class="menu-area">
                        ...
                        <ul class="menu-right-content">
                            <li class="btn-box">
                                <a href="#pricing" class="theme-btn btn-one"><span>Get One Month Free</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.php"><img src="assets/images/logo-2.png" alt="" title=""></a>
                </div>
